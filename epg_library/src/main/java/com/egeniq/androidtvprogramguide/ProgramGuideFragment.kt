...
abstract class ProgramGuideFragment<T> : Fragment(), ProgramGuideManager.Listener,
    ...
    protected open val DISPLAY_TIMEZONE: ZoneId = ZoneOffset.ofHoursMinutes(5, 30)
    ...
    private fun autoScrollToBestProgramme(
        ...
        val gmtPlus5_30 = ZoneOffset.ofHoursMinutes(5, 30)
        val nowMillis = Instant.now().atZone(gmtPlus5_30).toInstant().toEpochMilli()
