...
internal class ProgramGuideRowAdapter(
    ...
    internal class ProgramRowViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private fun onBindChannel(channel: ProgramGuideChannel?) {
            ...
            if(channel.isCatchup){
                channelContainer.setBackgroundResource(R.drawable.background_channel_catchup)
                channelNameView.setTextColor(Color.BLACK)
            }else{
                channelContainer.setBackgroundResource(R.drawable.background_channel)
