package com.siti.mobilesds.mvvm.login.view;

import static com.siti.mobilesds.Utils.KeyPreferencesKt.FALSE_STRING;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_ADMIN_ID;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_AREA_CODE;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_AUTHCODE;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_AUTH_TOKEN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_BANNER;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_EXP_DATE;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_FIRST_LOGIN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_HEADER_VALIDITY;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_INTERVAL;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_LEANBACK_ENABLED;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_MAC;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_NAME;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_PASSWORD;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_SERVER_IP;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_SERVER_IP_ADMIN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.KEY_SOCKET;
...
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_GLOBAL_IP_ADMIN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_GLOBAL_IP_LOGIN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_GLOBAL_IP_SOCKET;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_IPTV_NAME;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_LOCAL_IP_ADMIN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_LOCAL_IP_LOGIN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_LOCAL_IP_SOCKET;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.SERVER_LOCAL_NAME;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.TRUE_STRING;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.VALUE_LOGGED_IN;
import static com.siti.mobilesds.Utils.KeyPreferencesKt.sharedPrefFile;
import static com.siti.mobilesds.Utils.SocketUtilsKt.checkStateServer;
...
import com.siti.mobilesds.mvvm.config.helpers.AnalyticsEventsHelper;
...
import com.siti.mobilesds.Utils.CurrentData;
import com.siti.mobilesds.Utils.Helper;
import com.siti.mobilesds.Utils.RetrofitClient;
import com.siti.mobilesds.Utils.StateChangedServer;
import com.siti.mobilesds.Utils.UserDatesMemory;
import com.siti.mobilesds.mvvm.loading.view.DataLoadingActivity;
...
//                        }
                    ...
                    Call<com.siti.mobilesds.Model.RetroFit.Login> call = apiInterface.getLogin(paramObject.toString());

                    call.enqueue(new Callback<com.siti.mobilesds.Model.RetroFit.Login>() {
                        @Override
                        public void onResponse(Call<com.siti.mobilesds.Model.RetroFit.Login> call, Response<com.siti.mobilesds.Model.RetroFit.Login> response) {
//                            LoginProgressBar.setVisibility(View.GONE);
                            Login.setEnabled(true);
                            if (response.code() == 200) {
                                hideKeyboard(Password);
                                hideKeyboard(Username);
                                com.siti.mobilesds.Model.RetroFit.Login obj = response.body();
                        ...
                        @Override
                        public void onFailure(Call<com.siti.mobilesds.Model.RetroFit.Login> call, Throwable t) {
